        ...
        <Grid item xs={12} md={6}>
          <div>
            <Typography component="h2" variant="h4" color="text.primary">
              The All-in-One solution for managing finances and tenants
            </Typography>
            <Typography
              variant="body1"
              ...
              sx={{ mb: { xs: 2, sm: 4 } }}
            >
              LeaseLink’s intuitive toolset helps half a million landlords and investors streamline their entire rental process for free – whether they have one or 1,000 units.
            </Typography>
          </div>
